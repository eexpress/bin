...
s0_minimize_options = ;
s0_minimize_random_effects = animation:Curved Fold;animation:Horizontal Folds;animationaddon:Beam Up;animationaddon:Skewer;animationaddon:Razr;animationaddon:Leaf Spread;animationaddon:Domino;animationaddon:Fold;animation:Sidekick;animation:Dream;animation:Fade;animation:Glide 1;animation:Glide 2;animationaddon:Glide 3;animationaddon:Burn;animationaddon:Explode;animation:Magic Lamp;animationaddon:Airplane;animation:Zoom;
...
as_directory = 
as_launch_app = pasteimg.pl

[fade]
s0_fade_mode = 0
s0_fade_speed = 2.000000
s0_fade_time = 100
...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;vpswitch;regex;workarounds;dbus;png;screenshot;text;svg;mousepoll;session;imgjpeg;gnomecompat;shift;snap;thumbnail;animation;wall;obs;animationaddon;wobbly;expo;fade;scale;addhelper;
...
as_toggle_window_shaded_key = <Super>z
